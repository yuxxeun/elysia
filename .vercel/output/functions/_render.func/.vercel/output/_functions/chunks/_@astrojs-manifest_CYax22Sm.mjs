import "cookie";
import "kleur/colors";
import { D as DEFAULT_404_COMPONENT } from "./astro/server_DI3ovVLK.mjs";
import "clsx";
...
const manifest = deserializeManifest({
	hrefRoot: "file:///D:/@yuxxeun/my-astro-project-using-bun/",
	...
	routes: [
		...
		},
		{
			...
			links: [],
			scripts: [],
			styles: [{ type: "external", src: "/_astro/index.BMTRAcdn.css" }],
			routeData: {
				route: "/",
				isIndex: true,
				type: "page",
		...
		},
		{
			...
			routeData: {
				...
				type: "endpoint",
				pattern: "^(?:\\/(.*?))?\\/?$",
				segments: [[{ content: "...slugs", dynamic: true, spread: true }]],
				params: ["...slugs"],
				component: "src/pages/[...slugs].ts",
				prerender: false,
				fallbackRoutes: [],
				_meta: { trailingSlash: "ignore" },
			},
	...
	entryModules: {
		...
		"\u0000@astro-page:src/pages/[...slugs]@_@ts": "pages/_---slugs_.astro.mjs",
		"\u0000@astrojs-ssr-virtual-entry": "entry.mjs",
		"\u0000noop-middleware": "_noop-middleware.mjs",
		"\u0000@astro-renderers": "renderers.mjs",
		"D:/@yuxxeun/my-astro-project-using-bun/node_modules/astro/dist/env/setup.js":
			"chunks/astro/env-setup_Cr6XTFvb.mjs",
		"\u0000@astrojs-manifest": "manifest_DSygdnai.mjs",
		"astro:scripts/before-hydration.js": "",
	},
	inlinedScripts: [],
	assets: ["/_astro/index.BMTRAcdn.css", "/favicon.svg"],
