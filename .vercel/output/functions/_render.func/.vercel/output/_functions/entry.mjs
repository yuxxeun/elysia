...
import {
	e as ensure404Route,
	d as default404Instance,
	D as DEFAULT_404_ROUTE,
	m as manifest,
} from "./chunks/_@astrojs-manifest_CYax22Sm.mjs";
import {
	A as AstroError,
	q as i18nNoLocaleFoundInPath,
	s as appendForwardSlash,
	t as joinPaths,
	R as ResponseSentError,
	u as MiddlewareNoDataOrNextCalled,
	v as MiddlewareNotAResponse,
	G as GetStaticPathsRequired,
	w as InvalidGetStaticPathsReturn,
	x as InvalidGetStaticPathsEntry,
	y as GetStaticPathsExpectedParams,
	z as GetStaticPathsInvalidRouteParam,
	B as trimSlashes,
	P as PageNumberParamNotFound,
	C as NoMatchingStaticPathFound,
	H as PrerenderDynamicEndpointPathCollide,
	J as ReservedSlotName,
	L as LocalsNotAnObject,
	K as PrerenderClientAddressNotAvailable,
	Q as ClientAddressNotAvailable,
	S as StaticClientAddressNotAvailable,
	T as RewriteWithBodyUsed,
	U as AstroResponseHeadersReassigned,
	V as fileExtension,
	W as slash,
	X as prependForwardSlash,
	Y as removeTrailingForwardSlash,
} from "./chunks/astro/assets-service_-hU_Riyx.mjs";
import {
	R as ROUTE_TYPE_HEADER,
	g as REROUTE_DIRECTIVE_HEADER,
	h as createSlotValueFromString,
	r as renderTemplate,
	f as renderComponent,
	D as DEFAULT_404_COMPONENT,
	i as renderSlotToString,
	j as renderJSX,
	k as chunkToString,
	l as isRenderInstruction,
	n as clientLocalsSymbol,
	o as clientAddressSymbol$1,
	A as ASTRO_VERSION,
	p as responseSentSymbol$1,
	q as renderPage,
	t as REWRITE_DIRECTIVE_HEADER_KEY,
	u as REWRITE_DIRECTIVE_HEADER_VALUE,
	v as renderEndpoint,
	w as REROUTABLE_STATUS_CODES,
...
function getPattern(segments, base, addTrailingSlash) {
	const pathname = segments
		...
		.join("");
	const trailing =
		addTrailingSlash && segments.length
...
function ensureServerIslandRoute(config, routeManifest) {
	if (
		routeManifest.routes.some(
			(route) => route.route === "/_server-islands/[name]",
		)
	) {
		return;
	}
	...
	return manifest.routes.find((route) => {
		return (
			...
			route.fallbackRoutes.some((fallbackRoute) =>
				fallbackRoute.pattern.test(decodedPathname),
			)
		);
	});
}
...
await import("./chunks/astro/env-setup_Cr6XTFvb.mjs")
...
const _page2 = () => import("./pages/_---slugs_.astro.mjs");

const pageMap = new Map([
	["node_modules/astro/dist/assets/endpoint/generic.js", _page0],
	["src/pages/index.astro", _page1],
	["src/pages/[...slugs].ts", _page2],
]);
...
const _args = {
	middlewareSecret: "0cebe071-2fef-4d87-a07f-a89eff8dc1bb",
